...
# モデルを保存するファイルパス
filepath = './model/cifar10_Xception_finetuning_model_holdout.h5'
...
def save_model(model):
    ...
    if not os.path.isdir("cache"):
        os.mkdir("cache")
    json_name = "architecture_Xception.json"
...
# ファイルのエクスポート
sub.to_csv('./submit/cifar10_Xception_finetuning_model_holdout.tsv', sep='\t', header=None, index=None)