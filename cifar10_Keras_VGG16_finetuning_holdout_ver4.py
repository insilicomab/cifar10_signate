...
# モデルを保存するファイルパス
filepath = './model/cifar10_VGG16_finetuning_model_holdout_ver4.h5'
...
# ファイルのエクスポート
sub.to_csv('./submit/cifar10_VGG16_finetuning_model_holdout_ver4.tsv', sep='\t', header=None, index=None)